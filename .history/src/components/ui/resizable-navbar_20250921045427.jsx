...
export const NavBody = ({ children, className, visible }) => {
  return (
    <Motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto flex w-full max-w-7xl flex-row items-center justify-between self-start bg-black px-4 py-2",
...
export const NavItems = ({ items, className, onItemClick }) => {
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-1 flex-row items-center justify-center space-x-2 text-sm font-medium text-white transition duration-200 hover:text-zinc-200",
        className,
      )}
    >
      {items.map((item, idx) => (
