// filepath: c:\Users\ktpl-0173\Documents\git\techgenInformatics\src\components\simple-navbar.jsx
...
export default function SimpleNavbar() {
  ...
  return (
    <nav className={`w-full fixed top-0 z-50 ${scrolled ? 'bg-black shadow-lg' : 'bg-black bg-opacity-90'}`}>
                ...
                {item.name === "About Us" ? (
                  <div className="relative">
                    <button 
                      ...
                      onBlur={() => setTimeout(() => setAboutDropdownOpen(false), 100)}
                    >
                      {item.name}
                      <svg className={`ml-1 h-4 w-4 transform ${aboutDropdownOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
